...
class xiansuo(unittest.TestCase):
    ...
    def test_shangji(self):
        common.click_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/ul[1]/li[3]/a')
        common.click_element(By.XPATH,'/html/body/div[5]/div[2]/div[1]/div/a')
        common.click_element(By.XPATH,'//*[@id="owner_name"]')
        common.click_element(By.XPATH,'//*[@id="d_content"]/tr[5]/td[1]/input')
        common.click_element(By.XPATH,'/html/body/div[12]/div[3]/div/button[1]')
        common.click_element(By.XPATH,'//*[@id="customer_name"]')
        common.click_element(By.XPATH,'//*[@id="datas"]/tr[1]/td[1]/input[1]')
        common.click_element(By.XPATH,'/html/body/div[10]/div[3]/div/button[1]')
        common.input_text(By.XPATH,'//*[@id="name"]',ge[num])
        common.input_text(By.XPATH,'//*[@id="estimate_price"]',5000)
