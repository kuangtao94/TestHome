...
import time
from TestCase.auto_test_leke.interface_test.config import param       #导入配置文件
from TestCase.auto_test_leke.interface_test.common.log import log     #导入日志的类
from TestCase.auto_test_leke.interface_test.common.auto_email import a_email    #导入发送邮件的类
#导入自定义的测试用例类
...
suit=unittest.defaultTestLoader.discover(param.case_path,'wy_*.py')
...
runner=HTMLTestRunner.HTMLTestRunner(stream=fp,title=u'接口测试生成报告',tester=u'陈富华')
